<x-app-layout>
    ...
    <div class="py-6 max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        {{-- Filtros --}}
        <form method="GET" class="bg-white dark:bg-gray-800 p-6 rounded shadow mb-6 grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <select name="product_id" class="mt-1 w-full rounded border-gray-300 dark:bg-gray-900 dark:text-gray-200">
        ...
        <div class="bg-white dark:bg-gray-800 rounded shadow p-6">
            @if($sales->isEmpty())
                <p class="text-center text-gray-500 dark:text-gray-400">No hay resultados con los filtros actuales.</p>
            @else
